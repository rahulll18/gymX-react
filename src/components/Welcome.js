...
const Welcome = () =>{
    return(
        <div id="welcome"  className="h-screen md:[85vh] mt-[52px] md:mt-[60px] flex flex-col md:flex-row justify-evenly md:justify-around">
            <div id="content_1" data-aos-delay="400" data-aos="fade-right" className="section_content p-3  md:my-0 text-center md:text-start md:block">
                ...
                <button className='bg-lime-400 w-64 md:mt-10 mt-14 md:my-0 hover:bg-lime-500 rounded-xl text-lg text-black px-16 py-5 transition-all duration-500 delay-150 ease-in shadow-lg shadow-white'><Link to='/login'>Get started <i className="ri-arrow-right-line ml-2"></i></Link></button>
            </div>
