...
const Products = () => {
  ...
  return (
   <div className='h-full z-0 bg-gray-900'>
        ...
        {
            filteredProducts.length === 0 ? <div className='font-bold fixed bg-gray-900 top-[18%] md:top-[27%] h-screen w-full'> <h2 className='text-white fixed w-full top-[40%] md:text-4xl text-3xl  text-center'>No Products <span className='text-red-600'>found</span> </h2> </div> 
            :
            <div>
