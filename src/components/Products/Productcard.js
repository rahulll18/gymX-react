...
const Productcard = ({productlist}) => {
  ...
  return (
    <>
    <div data-aos="fade-up" className="md:max-w-[250px] md:h-[400px] m-5 transition-transform duration-300 bg-[hsl(180,12%,20%)] flex flex-col items-center rounded-lg shadow-xl hover:scale-105 cursor-pointer">
