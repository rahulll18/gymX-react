  ...
  return (
    <div id='Store' className='md:h-screen md:mt-0 mt-12 scroll-my-[65px]  box-border'>
      ...
      <div className="flex flex-col items-center md:flex-row md:justify-around md:items-center max-w-full ">
        <div className="bg-gray-800 p-4 rounded-lg shadow-lg text-center transition-transform duration-300 transform hover:scale-105 hover:bg-gray-700 md:w-1/4 w-80 md:my-0 my-3 md:max-h-[380px] max-h-[400px] md:mx-2">
          <img
        ...
        <div className="bg-gray-800 p-4 rounded-lg shadow-lg text-center transition-transform transform duration-300  hover:scale-105 hover:bg-gray-700 md:w-1/4 w-80 md:my-0 my-3 md:max-h-[380px] max-h-[400px] md:mx-2">
          <img
            src={supplements}
            alt="Supplements"
            className="w-44 mx-auto my-0 h-[200px] rounded-lg mb-5"
