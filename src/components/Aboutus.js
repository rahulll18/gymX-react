const Aboutus = ()=>{
    return(
        <div id='aboutUs' className="md:h-screen scroll-my-[65px] md:scroll-my-[65px] flex justify-center items-center p-5 box-border z-0">
            <div className="md:max-w-3xl max-h-[70%] md:max-h-[90%] max-w-sm text-center bg-gray-800 md:p-8 p-8  md:mt-0 rounded-lg shadow-lg transition-transform transform duration-300 hover:scale-105">
